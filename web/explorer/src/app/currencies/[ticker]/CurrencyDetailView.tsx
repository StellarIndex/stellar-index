...
XLM has a fixed maximum supply of ~50B; the Stellar Development Foundation periodically retires from its inflation pool. Unlike Bitcoin's purely-mined supply curve, lumen supply changes are governed by SDF allocation policy.`,
  CAD: `The Canadian dollar — nicknamed the "loonie" after the common loon depicted on the C$1 coin — is issued by the Bank of Canada. It is widely tracked as a "commodity currency" because Canada's economy is heavily exposed to crude oil, natural gas, and base-metal exports; CAD movements correlate strongly with WTI prices on multi-week timescales.`,
  AUD: `The Australian dollar replaced the Australian pound on a 2-for-1 basis in 1966. Issued by the Reserve Bank of Australia, it is among the most-traded currencies on FX markets despite Australia's modest population, partly because its high real interest rate and AAA credit rating make it a popular carry-trade target.`,
  NZD: `The New Zealand dollar — the "kiwi" after the bird on the NZ$1 coin — is issued by the Reserve Bank of New Zealand. Like its trans-Tasman counterpart AUD, it tracks commodity cycles (dairy + agricultural exports) and tends to move in correlation with risk-on / risk-off sentiment in the wider G10 set.`,
  BRL: `The Brazilian real became Brazil's currency in 1994 as part of the "Plano Real" stabilisation package that ended a decades-long hyperinflation. Issued by the Banco Central do Brasil, it floats freely against USD; the BRL/USD pair is widely watched as a barometer for Latin-American emerging-markets risk.`,
  MXN: `The Mexican peso has the same root as Spain's peso — both descend from the Spanish silver "pieces of eight" that circulated globally in the 17th–19th centuries. Issued by Banco de México, it is one of the most-traded emerging-market currencies and a major remittance corridor (USD → MXN flows from Mexicans working in the US).`,
  ZAR: `The South African rand is named after the Witwatersrand, the gold-bearing reef around Johannesburg whose discovery in 1886 catalysed South Africa's industrialisation. Issued by the South African Reserve Bank, it serves as the de-facto reference currency for several smaller Southern African economies via the Common Monetary Area.`,
  KRW: `The South Korean won replaced the hwan in 1962 as part of a broader monetary reform. Issued by the Bank of Korea, it operates without subdivisions in everyday use — there are technically 100 jeon to a won, but jeon are rarely seen and exist mainly in financial accounting.`,
  TRY: `The Turkish lira's "₺" symbol, adopted in 2012, was designed to evoke the letter "L" with two horizontal strokes representing economic stability. Issued by the Central Bank of the Republic of Türkiye, the lira has experienced significant inflation in recent years; rate-watchers track CBRT policy decisions closely.`,
  RUB: `The Russian ruble traces continuous use back to the 13th century, longer than any other modern fiat currency by some measures. Issued by the Central Bank of the Russian Federation, it has been subject to extensive Western sanctions since 2022; live forex pricing reflects what's available through the unsanctioned correspondent network.`,
  SGD: `The Singapore dollar is managed under a managed-float regime against an undisclosed basket of currencies — the Monetary Authority of Singapore targets exchange-rate appreciation rather than interest rates as its primary monetary policy lever, an unusual approach among advanced economies.`,
  HKD: `The Hong Kong dollar has been pegged to the US dollar since 1983, currently at 7.75–7.85 HKD per USD via the Linked Exchange Rate System administered by the Hong Kong Monetary Authority. The peg makes HKD effectively a USD proxy for FX-routing purposes despite Hong Kong's distinct monetary regime.`,
  SEK: `The Swedish krona is one of the older European currencies that opted not to adopt the euro after the 2003 referendum rejection. Issued by Sveriges Riksbank — the world's oldest central bank, founded 1668 — and one of the few G10 currencies to have run negative interest rates for an extended period (2015–2019).`,
  NOK: `The Norwegian krone, like its Swedish and Danish neighbours, traces back to the 1873 Scandinavian Monetary Union. Issued by Norges Bank, it tracks Brent crude prices closely because Norway's sovereign wealth fund and current account are heavily oil-and-gas dependent.`,
  DKK: `The Danish krone is pegged to the euro under the ERM II mechanism with a ±2.25% band, kept tight by the Danmarks Nationalbank. The peg makes DKK effectively a euro proxy for cross-rate purposes, but Denmark retains its own monetary policy via the central-bank rate.`,
};
