    ...
    <div className="mx-auto max-w-6xl space-y-6 p-6">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="mt-4 flex flex-wrap gap-3 text-xs">
          <a
            href="https://github.com/RatesEngine/rates-engine/blob/main/docs/discovery/dexes-amms/blend.md"
            className="inline-flex items-center gap-1 text-brand-600 hover:underline"
            target="_blank"
            rel="noreferrer"
          >
            Discovery notes (Blend)
            <ExternalLink className="h-3 w-3" />
          </a>
          <a
            href="https://github.com/RatesEngine/rates-engine/blob/main/docs/discovery/dexes-amms/comet.md"
            className="inline-flex items-center gap-1 text-slate-500 hover:underline"
            target="_blank"
            rel="noreferrer"
          >
            Discovery notes (Comet backstop)
            <ExternalLink className="h-3 w-3" />
          </a>
          <a
