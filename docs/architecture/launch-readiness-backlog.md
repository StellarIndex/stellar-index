...
| L2.12 | `internal/supply/` package — circulating supply per ADR-0011 | Wk 6 | ~2 days | — | L3.* (F2 fields) | `internal/supply/{circulating,total,max}` | 🟡 |
...
| L3.5 | F2.* Market Cap / FDV / 24h Volume / Circulating / Max Supply on asset detail | Wk 7 | full day | L2.12, L2.10 | launch | `internal/api/v1/assets.go` (extension) | 🔴 |
